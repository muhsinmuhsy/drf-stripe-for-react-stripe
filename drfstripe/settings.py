"""
Django settings for drfstripe project.
...
SECRET_KEY = 'django-insecure-##&)x3zliu$kos$$j769j6xr0ps)1k_4!^a(#54h$q9!@1&x0='
...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware',  # Add this line for corsheaders
    "django.middleware.common.CommonMiddleware",
]
...
WSGI_APPLICATION = 'drfstripe.wsgi.application'
